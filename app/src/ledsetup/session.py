...
from ledsetup.device import addresses_equal, normalize_address
from ledsetup.exceptions import NotConnectedError
from ledsetup.types import BleClient, ClientCloser, ClientOpener, LogFn
...
class BleSession:
    ...
    async def connect(self, address: str) -> GattSnapshot:
        ...
        self._notify_enabled = await enable_kit_notify(client, self._snapshot, self._log)
        return self._snapshot
